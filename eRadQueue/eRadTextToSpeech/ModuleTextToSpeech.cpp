...
MRET CModuleTextToSpeech::SpeakText(CString strSpeakContent, LONG nVoiceRate, LONG nVoiceVolume, LONG nVoiceClassified)
{
	...
	return this->m_pSpeakText(strSpeakContent, nVoiceRate, nVoiceVolume, nVoiceClassified);
}
