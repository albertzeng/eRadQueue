...
typedef MRET	(*SPEECH_SpeakText)		(LPCTSTR lpSpeakContent, LONG nVoiceRate, LONG nVoiceVolume, LONG nVoiceClassified);
...
public:
	MRET						SpeakText(CString strSpeakContent, LONG nVoiceRate, LONG nVoiceVolume, LONG nVoiceClassified);
